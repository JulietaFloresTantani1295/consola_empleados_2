...
if(count($students3)>0){
 ...
 if(count($pre)>0){
   ...
   echo "<br>";
              ...
              $buscar_l=query("SELECT * FROM reportedias_nomarcados cc WHERE cc.codigo_e=$codigo_empleado  AND cc.Fecha BETWEEN '$fi_pv' AND '$ff_pv'  AND   isnull(cc.idtab) ORDER BY cc.Fecha DESC");
              if(count($buscar_l)>0){
